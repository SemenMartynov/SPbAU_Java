 ...
 * 
 *         The class checks compliance between file name and the regular expression line.
 */
public class PatternFilter implements FileFilter {
	/**
	 * Constructor from the regular expression line.
	 * 
	 * @param filterConditions the regular expression line (see http://docs.oracle.com/javase/7/docs/api/java/util/regex/Pattern.html).
	 ...
	 * 
	 * @param file for the matching.
	 * @return true if, and only if, the entire file's name matches filter's pattern
	 */
    @Override
